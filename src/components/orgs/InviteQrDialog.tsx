...
export function InviteQrDialog({
  ...
  return (
    <div
      className="fixed inset-0 z-[100] flex items-center justify-center overflow-y-auto overscroll-contain bg-black/70 p-4"
      onClick={(e) => {
    ...
    >
      ...
      >
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-5 py-5">
          ...
          <div className="relative mx-auto flex aspect-square w-full max-w-[248px] items-center justify-center rounded-xl bg-white p-3">
            {active && !isDead ? (
              <div
        ...
        <div className="flex shrink-0 items-center gap-2 border-t border-border-light/40 px-5 py-4">
          <button
            type="button"
