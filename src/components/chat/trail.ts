/**
 * The audit trail of a single turn.
 *
 ...
 * client from the moment the turn was sent, so it includes network time and is
 * labelled as time-since-start rather than as a server-side duration.
 */
...
export interface TrailEvent {
  /** Stable within a turn; the list is rendered keyed by it. */
  id: string;
  kind: TrailKind;
