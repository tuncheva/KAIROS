...
export function SignInModal({
  ...
  const primaryBtnClass =
    "k-btn flex items-center justify-center gap-2.5 rounded-xl bg-accent-primary px-7 py-4 text-base font-bold text-white disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:translate-y-0 disabled:hover:shadow-none";
  const backLinkClass =
